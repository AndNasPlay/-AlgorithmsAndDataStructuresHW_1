...
//	printf("13 - Написать функцию, генерирующую случайное число от 1 до 100. (с использованием стандартной функции rand() и без).\n");
...
//
//	int n, i, sym = 0, countForSym = 0, z = 0;
//	int arr[100];
//
...
//}
//
//// MARK: Задание 12. Написать функцию нахождения максимального из трех чисел.
//
//int funcFindTheHighestValue(int a, int b, int c) {
//	return ((funcFindMaxValue(a, b)) > c ? ((funcFindMaxValue(a, b))) : c);
//}
//
...
//	int greatestValue;
//
//	printf("Input you 3 values ");
//	scanf("%d %d %d", &a, &b, &c);
//
//	greatestValue = funcFindTheHighestValue(a, b, c);
//
//	printf("Самое больше значени - %d \n", greatestValue);
//}
//
//// MARK: Задание 13. Написать функцию, генерирующую случайное число от 1 до 100. (с использованием стандартной функции rand() и без)
//
//void solution13(void) {
//
//	int a, x = 1, m = 1000;
//	struct timeval tv = { 0 };
//
//	printf("С использованием стандартной функции rand() 1 без 0 \n");
//	scanf("%d", &a);
//
//	if (a == 1) {
...
//		x = (tv.tv_sec * tv.tv_sec/1500 + (tv.tv_sec/3600)) % m;
//		printf("Случайное число = %d \n", x);
//	}
//}
//
//// MARK: Задание 14. Автоморфные числа. Натуральное число называется автоморфным, если оно равно последним цифрам своего квадрата. Например, 25 = 625. Напишите программу, которая вводит натуральное число N и выводит на экран все автоморфные числа, не превосходящие N.
//
//void solution14(void) {
//	int n, i = 0, countOfDigits, countOfDigitsInN, powOfN, denominator = 10;
//
//	printf("Input N \n");
//	scanf("%d", &n);
//
//	while (i <= n) {
//		powOfN = pow(i, 2);
//		countOfDigits = funcSearchCountOfDigits(powOfN);
//		countOfDigitsInN = funcSearchCountOfDigits(i);
//
//		if (countOfDigitsInN == 2) {
//			denominator = 100;
//		} else if (countOfDigitsInN == 3) {
//			denominator = 1000;
//		} else if (countOfDigitsInN == 4) {
//			denominator = 10000;
//		} else if (countOfDigitsInN == 4) {
//			denominator = 100000;
//		}
//
//		if (powOfN % denominator == i) {
//			printf("Автоморфное %d \n ", i);
//		}
//		i++;
//	}
//}
